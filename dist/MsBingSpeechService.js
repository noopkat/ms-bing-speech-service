...
const protocolHelper = __webpack_require__(3);
const messageParser = __webpack_require__(10);
const sendFile = __webpack_require__(11);
const BingSpeechServiceInject = __webpack_require__(12);
...
/* WEBPACK VAR INJECTION */(function(Buffer) {const os = __webpack_require__(9);
...
/* WEBPACK VAR INJECTION */(function(process) {module.exports = function (dependencies) {
  const {
    websocket,
    uuid,
    fetch,
  ...
  class BingSpeechService extends eventEmitter {
    ...
    _getAccessToken() {
      ...
      // request token
      return fetch(this.issueTokenUrl, postRequest).then(res => res.text());
    }
