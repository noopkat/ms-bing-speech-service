...
var protocolHelper = __webpack_require__(3);
var messageParser = __webpack_require__(10);
var sendFile = __webpack_require__(11);
var BingSpeechServiceInject = __webpack_require__(12);

var dependencies = { websocket: websocket, uuid: uuid, fetch: fetch, eventEmitter: eventEmitter, debug: debug, protocolHelper: protocolHelper, messageParser: messageParser, sendFile: sendFile };
...
function format(headers) {
  var hStrings = headers.map(function (header) {
...
protocolHelper.createSpeechConfigPacket = function (connectionId) {
  ...
  var osVersionShort = osPlatform === 'win32' ? osVersion.split('.')[0] : osVersion.split('.')[1];

  var osPlatformHuman = osMap.platform[osPlatform] || 'Unknown';
  var osName = osMap.name[osPlatform] && osMap.name[osPlatform][osVersionShort] ? osMap.name[osPlatform][osVersionShort] : 'Unknown';
